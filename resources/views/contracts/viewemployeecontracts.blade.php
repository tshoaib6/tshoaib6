        ...
        <div class="shadow-lg p-3">
          ...
          @include('errors.messages')
                ...
                <div class="subject form-group form-inline">
                    <label >Subject : </label>
                    <input type="text" class="form-control @error('subject') is-invalid @enderror"  id="exampleInputEmail1" name="subject" style="margin-left:5px;" readonly value="{{$contractYcm[0]->subject}}">
                ...
                <div class="subject form-group form-inline">
                    ...
                    <input type="text" class="form-control" readonly name="name" style="margin-left:5px;"placeholder="Name" readonly value="{{$contractYcm[0]->name}}
"">

                </div>

                <div class="subject">
                    <p>We are pleased in conveying to you that approval is granted for your appointment at Youth Club Trust, at the position <input type="text" class="input-style" readonly value="{{$contractYcm[0]->position}}
" name="position" id="position" size="10" > period of <span form-group form-inline> <input readonly value="{{$contractYcm[0]->period}}
" type="text" class="input-style @error('period') is-invalid @enderror" name="period" id="position" size="10"> </span> years from <span form-group form-inline>
                        <input readonly value="{{$contractYcm[0]->started}}
" class="input-style"type="text" id="datefrom" name="from" id="position" size="10"> </span> until <span form-group form-inline> <input readonly value="{{$contractYcm[0]->until}}
" class="input-style" id="dateto" type="text" name="until" id="position" size="10"> </span>. As per your job description, you will be based at the Youth Club Trust  Office in <span form-group form-inline> <input readonly value="Islamabad
"type="text" class="input-style @error('city') is-invalid @enderror" name="city" id="position" size="10"> </span>. <br> <br>
                        Please note that there is a 3-month probation period, from <span form-group form-inline> <input readonly value="{{$contractYcm[0]->probabtion_start}}
" class='input-style 'id="pdatefrom"  type="text" name="probabtion_from"  size="10"> </span> to <span form-group form-inline> <input  class="input-style"  readonly value="{{$contractYcm[0]->probabtion_end}}
" id="pdateto" type="text" name="probabtion_until"  size="10"> </span>. Your contract will officially start after the probation period subject to approval. You will be eligible to apply for
                        ...
                        Your salary for this post will be Rs. <span form-group form-inline> <input readonly value="{{$contractYcm[0]->salary }}
